    ...
    (cases expression exp
      ...
      (new-object-exp (class-name rands)
                      (let ((args (values-of-exps rands env))
                        ...
                        obj))
	  ; ==============ADDITIONS=FROM=HERE=====================================
	  ; Returns whether the given obj-exp is an instance of the given class name
      (instance-of-exp? (obj-exp class-name) 
						(let ((obj (value-of obj-exp env))) ; get the actual object from env
						  ;wrap result of instancof function in bool-val
						  (bool-val (instanceof (object->class-name obj) class-name)))) 
      (self-exp ()
                (apply-env env '%self))
      
	  (static-method-call-exp (obj-exp class-name method-name rands) ;TODO
                       (let ((args (values-of-exps rands env))
                             (obj (value-of obj-exp env)))
						 (if (instanceof (object->class-name obj) class-name)
							 (apply-method
...
;; Search recursively for an instance of the given class-name
;; Until you reach the object class 
