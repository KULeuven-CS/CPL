...
; 'o3 is an instance of class 3 so should evaluate to #t
(define instanceof1
  (a-program
   (list
    (a-class-decl 'c1 'object '()
   ...
   (let-exp '(o3) 
            (list (new-object-exp 'c3 (list)))
            (instance-of-exp? (var-exp 'o3) 'c3))))

;Check for instanceof1
(check-equal?
 (value-of-program instanceof1)
 (bool-val #t))

;Same example as p8 but testing instanceof
; 'o3 is NOT an instance of class 2 so should evaluate to #f
(define instanceof2
  (a-program
   (list
    (a-class-decl 'c1 'object '()
   ...
   (let-exp '(o1) 
            (list (new-object-exp 'c1 (list)))
            (instance-of-exp? (var-exp 'o1) 'c2))))

;Check for instanceof2
(check-equal?
 (value-of-program instanceof2)
 (bool-val #f))

;Same example as p8 but testing instanceof
; 'o2 is an instance of (superclass) class 1 so should evaluate to #t
(define instanceof3
  (a-program
   (list
    (a-class-decl 'c1 'object '()
   ...
   (let-exp '(o2) 
            (list (new-object-exp 'c2 (list)))
            (instance-of-exp? (var-exp 'o2) 'c1))))

;Check for instanceof3
(check-equal?
 (value-of-program instanceof3)
 (bool-val #t))

;Same example as p8 but testing staticcall
(define staticcall1
  (a-program
   (list
    (a-class-decl 'c1 'object '()
   ...
   (let-exp '(o2) 
            (list (new-object-exp 'c2 (list)))
            (static-method-call-exp (var-exp 'o2) 'c1 'm1 '()))))

;check for staticcall1
(check-equal?
 (value-of-program staticcall1)
 (num-val 23))
